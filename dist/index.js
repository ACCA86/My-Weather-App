...
const btn = document.querySelector('.btn'), img = document.querySelector('#wth-icon'), city = document.querySelector('.city'), temp = document.querySelector('.temp'), num = document.querySelector('.num'), weather = document.querySelector('.weather'), rang = document.querySelector('.rang'), date = document.querySelector('.date'), conDetails = document.querySelector('#details'), backArrow = document.querySelector('.arrow-back'), error = document.querySelector('.error');
...
function GetDate() {
    let days = ['Sunday', 'Monday', 'Tuesdaay', 'Wednesday', 'Therday', 'Friday', 'Saturday'];
